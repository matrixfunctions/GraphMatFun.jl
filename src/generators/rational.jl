...
see, e.g., [`graph_monomial`](@ref) and [`graph_ps`](@ref).
...
function graph_rational(den_coeffs, num_coeffs, poly_gen)
    ...
    return graph_rational(den_graph, num_graph; den_cref=den_cref, num_cref=num_cref)
end

function graph_rational(den_graph, num_graph; den_cref=Vector{Tuple{Symbol,Int}}(), num_cref=Vector{Tuple{Symbol,Int}}())
