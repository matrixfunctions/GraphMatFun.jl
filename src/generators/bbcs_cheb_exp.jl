...
function gen_bbcs_cheb_exp(k;T=Complex{BigFloat},compress_keys=true)
    ...
    if (k<=5) # Basic implementation from paper
        ...
        elseif (k==5) # Equation (25)
            ...
            # B_1 * B_5
            x4a = vcat(zero(CBF), BigFloat("3")/BigFloat("25"), BigFloat("-0.00877476096879703859")im, BigFloat("-0.00097848453523780954"), zero(CBF))
            x4b = vcat(zeros(CBF,2), BigFloat("-0.123953695858283131480")im, BigFloat("-0.011202694841085592373"), BigFloat("-0.000012367240538259896")im)


            # (B_3 + A_9)*A_9 = (B_3 + B_4 + previous)*(B_4 + previos)
            b3 = vcat(BigFloat("-2.58175430371188142440"), BigFloat("-1.73033278310812419209")im, BigFloat("-0.07673476833423340755"), BigFloat("-0.00261502969893897079")im, BigFloat("-0.00003400011993049304"))
            b4 = vcat(BigFloat("2.92377758396553673559"), BigFloat("1.44513300347488268510")im, BigFloat("0.12408183566550450221"), BigFloat("-0.01957157093642723948")im, BigFloat("0.00002425253007433925"))
            ...
            b2 = vcat(zero(CBF), BigFloat("-0.66040840760771318751")im, BigFloat("-1.09302278471564897987"), BigFloat("0.25377155817710873323")im, BigFloat("0.00054374267434731225"))
