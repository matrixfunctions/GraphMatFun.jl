...
@testset "degopt" begin
    ...
    # testing graph_degopt_poly
    (g1,_)=graph_degopt_poly(degopt1)

    # Testing grow
    degopt2=grow!(deepcopy(degopt1));
    (g2,_)=graph_degopt_poly(degopt1)
    ...
    (g3,_)=graph_degopt_poly(degopt3)
    ...
    scale!(degopt4,2);
    (g4,_)=graph_degopt_poly(degopt4);
    (g1,_)=graph_degopt_poly(degopt1);
    ...
    (g8,_)=graph_degopt_poly(degopt8);
    (g1,_)=graph_degopt_poly(degopt1);
